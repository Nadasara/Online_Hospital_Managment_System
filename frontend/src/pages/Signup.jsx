...
import avetar from '../images/doctor-img03.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <div className="mb-5 flex items-center gap-3">
              <figure className='w-[60px] h-[60px] rounded-full border-2 boder-sold border-primaryColor flex items-center justify-center '>
                <img src={avetar} alt='' className='w-full rounded-full'/>
              </figure>
              ...
              <div className='relative w-[160px] h-[50px]'>
                ...
                <label
                 ...
                 text-[17px] leading-5 overflow-hidden bg-[#0066ff46] text-headingColor
